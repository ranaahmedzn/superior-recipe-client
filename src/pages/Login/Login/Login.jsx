...
const Login = () => {
    return (
        <div className='min-h-[calc(100vh-88px)] h-full login-container'>
            <div className='max-w-screen-xl py-8 mx-auto flex items-center justify-center gap-10'>
                    ...
                    <div className=' px-10 py-10 rounded-xl bg-gray-200'>
                        ...
                        <form>
                            ...
                            <div className="mb-6">
                                ...
                                <input type="password" id="password" className="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder='Enter password' required />
                            </div>
                            ...
                            <button type="submit" className="submit-btn w-full rounded-full">Submit</button>
                        </form>
                    </div>
