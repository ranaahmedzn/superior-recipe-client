        ...
        <div className='min-h-[calc(100vh-88px)]'>
            ...
            >
                <SwiperSlide className='res-slide'>
                    <div className='max-w-screen-xl min-h-[calc(100vh-75px)] md:min-h-[calc(100vh-88px)] p-4 md:p-5 mx-auto flex  items-center'>
                        <div className='space-y-5 lg:w-1/2'>
                            <h2 className='font-bold text-[45px] lg:text-6xl leading-[55px] lg:leading-[80px] text-white'>A Journey Through Flavor and Tradition</h2>
                ...
                <SwiperSlide className='res-slide'>
                    <div className='max-w-screen-xl min-h-[calc(100vh-75px)] md:min-h-[calc(100vh-88px)] p-4 md:p-5 mx-auto flex  items-center'>
                        <div className='space-y-5 lg:w-1/2'>
                            <h2 className='font-bold text-[45px] lg:text-6xl leading-[55px] lg:leading-[80px] text-white'> The Fresh Ingredients of Italian Cooking</h2>
                ...
                <SwiperSlide className='res-slide'>
                    <div className='max-w-screen-xl min-h-[calc(100vh-75px)] md:min-h-[calc(100vh-88px)] p-4 md:p-5 mx-auto flex  items-center'>
                        <div className='space-y-5 lg:w-1/2'>
                            <h2 className='font-bold text-[45px] lg:text-6xl leading-[55px] lg:leading-[80px] text-white'> Healthy Eating with Italian Flair</h2>
