        ...
        <div className='min-h-[calc(100vh-88px)]'>
            ...
            >
                <SwiperSlide className='res-slide'>
                    <div className='max-w-screen-xl min-h-[calc(100vh-88px)] p-5 mx-auto flex items-center'>
                ...
                <SwiperSlide className='res-slide'>
                    <div className='max-w-screen-xl min-h-[calc(100vh-88px)] px-5 mx-auto flex items-center'>
                        <div className='space-y-5 w-1/2'>
